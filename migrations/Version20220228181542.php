 ...
 */
final class Version20220228181542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD note INT DEFAULT NULL');
    }
